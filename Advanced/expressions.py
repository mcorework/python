...
--Example 1 to understand the difference between an operator and expression
# 'x + y' is an expression
# '+' is the operator
result = x + y     # Expression evaluates to 15

--Example 2 to understand the difference between an operator and expression
> and and are operators
(x > y) and (y > 0) is an expression that evaluates to True or False
-------------------------------------------------------------------------------
