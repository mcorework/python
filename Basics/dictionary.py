"""
===========================================
🗂️ Python Dictionaries — Complete Documentation
===========================================

A **dictionary** in Python is an **unordered**, **mutable**, and **indexed** collection that stores data in **key–value pairs**.  
Each key must be **unique** and **immutable** (e.g., strings, numbers, tuples), while values can be of any type.
...
Important:
    Key: Must be unique and immutable (It can be of string, numbers, or tuples)
    Value: Can be any dta type and does not need to be unique
