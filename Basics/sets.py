"""
===========================================
🔶 Python Sets — Complete Documentation
===========================================

A **set** in Python is an **unordered**, **mutable**, and **unindexed** collection of **unique elements**.
It is commonly used to store data where **duplicates are not allowed** and for performing **mathematical set operations** 
...
Example:
    ...
    numbers = set([1, 2, 3, 3, 4])  # duplicates automatically removed → {1, 2, 3, 4}
